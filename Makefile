...
build_protoc:
	protoc -I$(project)/proto \
	--go_out=. \
	--go_opt=module=github.com/mbcarruthers/gRPCsqrt \
	--go-grpc_out=. \
	--go-grpc_opt=module=github.com/mbcarruthers/gRPCsqrt $(project)/proto/$(project).proto
...
clean_protoc:
	${RM_F_CMD} $(project)/${PROTO_DIR}/*.pb.go
...
about:
	...
	@echo "Go packge: ${PACKAGE}"
	@echo "Open SSL version $(shell openssl version)"
